...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        initComponents();
        setIconImage((new ImageIcon(getClass().getResource("merlin logo.png"))).getImage());
        setLocationRelativeTo(null);
        URL imgURL = MainFrame.class.getResource("/MPI/merlin icon title.png");
        if (imgURL != null) {
    ...
    private void initComponents() {
        ...
        logInPanel = new mpis_mariadb_2.LogInPanel();
        subFrame = new mpis_mariadb_2.SubFrame();
...
//            FlatGitHubIJTheme.setup();
    ...
    private mpis_mariadb_2.LogInPanel logInPanel;
    private javax.swing.JPanel mainPanel;
    private mpis_mariadb_2.SubFrame subFrame;
