...
public class Search extends javax.swing.JPanel {
    ...
    private boolean isNumeric(String given) {
        if (given == null) {
            return false;
        }
        try {
            Integer num = Integer.parseInt(given);
    ...
    public void updateYearCombo() {
        yearComboBox.removeAllItems();
        try {
            Connection connect = DriverManager.getConnection(this.driver, this.f_user, this.f_pass);
            Statement state = connect.createStatement();
            String query = "Select distinct(year(transaction_date)) from merlininventorydatabase.client_info";
            ResultSet rset = state.executeQuery(query);
            yearComboBox.addItem("All");
            while (rset.next())
                yearComboBox.addItem(rset.getString(1)); 
            state.close();
            connect.close();
        } catch (SQLException ex) {
    ...
    public void updateStatusCombo() {
        ...
        try {
            Connection connect = DriverManager.getConnection(this.driver, this.f_user, this.f_pass);
            Statement state = connect.createStatement();
            String query = "Select distinct(status) from merlininventorydatabase.client_info";
            ResultSet rset = state.executeQuery(query);
    ...
    private void updateStatusOfLoans() { 
        ...
        try {
            String updateStatusExp = "update merlininventorydatabase.client_info set status = 'Expired' where new_pap_num = 'null' and transaction_date <= '" + this.dateHelp.formatDate(expDate) + "' and status = 'Open'";
...
Color alternate = new Color(239,246,250);
     ...
     customerListingTable.getColumnModel().getColumn(4).setCellRenderer(new TextAreaCellRenderer());
    ...
    private void initComponents() {
        ...
        searchLoan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/magnifying-glass-search.png"))); // NOI18N
        ...
        searchPanelLayout.setHorizontalGroup(
            ...
            .addGroup(searchPanelLayout.createSequentialGroup()
                ...
                .addGroup(searchPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(searchPanelLayout.createSequentialGroup()
                        .addComponent(tempSearchName, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, 0)
                        .addComponent(searchLoan, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        if (customerListingTable.getColumnModel().getColumnCount() > 0) {
            customerListingTable.getColumnModel().getColumn(0).setPreferredWidth(5);
            customerListingTable.getColumnModel().getColumn(1).setPreferredWidth(50);
            customerListingTable.getColumnModel().getColumn(2).setPreferredWidth(70);
            customerListingTable.getColumnModel().getColumn(3).setPreferredWidth(90);
            customerListingTable.getColumnModel().getColumn(4).setPreferredWidth(170);
            customerListingTable.getColumnModel().getColumn(5).setPreferredWidth(80);
        }
        ...
        classificationSearch.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                classificationSearchActionPerformed(evt);
            }
        });
        ...
        statusComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Vehicle - 2W", "Vehicle - 4W", "Jewelry", "Appliance", "Gadget", "Others" }));
        ...
        monthComboBox.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        ...
        yearComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Vehicle - 2W", "Vehicle - 4W", "Jewelry", "Appliance", "Gadget", "Others" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(monthComboBox, 0, 0, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jLabel21, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(yearComboBox, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(12, 12, 12)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(yearComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(1, 1, 1)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(branchSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(classificationSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(1, 1, 1)
                                .addComponent(monthComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(papeletaNoVM, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                ...
                .addGap(1, 1, 1)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(insuranceVM, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(227, 240, 251))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(30, 30, 30)
                .addComponent(viewHistory, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(newLoanBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(renewLoanBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(redeemLoanBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
/*  790 */     if (key == 10) {
/*  791 */       searchLoanActionPerformed(null);
  } 
    ...
    private void searchLoanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchLoanActionPerformed
        ...
        if (this.tempSearchName.getText().isEmpty()) {
            ...
            if (this.branchSearch.getSelectedIndex() > 0) {
                filterSubstring = " and branch = '" + this.branchSearch.getSelectedItem().toString() + "'";
            }
            if (this.classificationSearch.getSelectedIndex() > 0) {
                filterSubstring += " and classification = '" + this.classificationSearch.getSelectedItem().toString() + "'";
            }
            if (this.statusComboBox.getSelectedIndex() > 0) {
                filterSubstring += " and status = '" + statusComboBox.getSelectedItem().toString() + "'";
            }
            if (this.monthComboBox.getSelectedIndex() > 0) {
                filterSubstring += " and month(transaction_date) = " + monthComboBox.getSelectedIndex() + " ";
            }
            if (this.yearComboBox.getSelectedIndex() > 0) {
                filterSubstring += " and year(transaction_date) = " + yearComboBox.getSelectedItem().toString()+ " ";
            }
            if (!isNumeric(this.tempSearchName.getText())) {
              searchSubstring = " where (client_name like '%" + this.tempSearchName.getText() + "%' or "
                      + "client_address like '%" + this.tempSearchName.getText() + "%' or "
                      + "item_description like '%" + this.tempSearchName.getText() + "%' or "
                      + "classification like '%" + this.tempSearchName.getText() + "%' or "
                      + "pap_num like '%" + this.tempSearchName.getText() + "%' )";
              query = query.concat(this.whereSearchPawn);
            } else {
                searchSubstring = " where pap_num = '" + tempSearchName.getText() + "' ";
            }

            try {
                System.out.println(query + searchSubstring + filterSubstring + " order by transaction_date desc, pap_num asc");
                updateTable(query + searchSubstring + filterSubstring + " order by transaction_date desc, pap_num asc");
            } catch (SQLException ex) {
                this.con.saveProp("mpis_last_error", String.valueOf(ex));
...
//        }
    ...
    private void classificationSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_classificationSearchActionPerformed
        if (tempSearchName.getText().length() > 0)
        searchLoanActionPerformed(null);
    }//GEN-LAST:event_classificationSearchActionPerformed

    private void branchSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_branchSearchActionPerformed
        if (tempSearchName.getText().length() > 0)
            searchLoanActionPerformed(null);
    }//GEN-LAST:event_branchSearchActionPerformed
